...
import { ensureElement, ensureImageElement, ensureButtonElement } from '../utils/utils';
...
export class ProductModalView implements IProductModalView {
  ...
  private actionHandler?: (product: Product, action: 'add' | 'remove') => void;
  ...
  private handleButtonClick(): void {
    ...
    this.actionHandler?.(this.currentProduct, action);
    this.closeHandler?.();
  }
